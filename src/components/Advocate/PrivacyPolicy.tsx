      ...
      <article className={`${styles.terms_and_conditions}`}>
        <div className="container">
          ...
          >
            ...
            <p>
              At {title}, accessible from {SITEURL} one of our main priorities
              is the privacy of our visitors. This Privacy Policy document
              contains types of information that is collected and recorded by{' '}
              {title} and how we use it.
            </p>
            ...
            <p>
              ...
              that they shared and/or collect in {title}. This policy is not
            ...
            <p>
              {title} follows a standard procedure of using log files. These
              files log visitors when they visit websites. All hosting companies
              do this and a part of hosting service&apos;s analytics. The
              information collected by log files include internet protocol (IP)
              addresses, browser type, Internet Service Provider (ISP), date and
              time stamp, referring/exit pages, and possibly the number of
              clicks. These are not linked to any information that is personally
              identifiable. The purpose of the information is for analyzing
              trends, administering the site, tracking user&apos;s movement on
            ...
            <p>
              Like any other website, {title} uses &apos;cookies&apos;. These
            ...
            <p>
              ...
              the advertising partners of {title}.
            </p>

            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on {title}, which
              are sent directly to user&apos;s browser. They automatically
            ...
            <p>
              Note that {title} has no access to or control over these cookies
            ...
            <p>
              {title}&apos;s Privacy Policy does not apply to other advertisers
            ...
            <p>
              {title} does not knowingly collect any Personal Identifiable
