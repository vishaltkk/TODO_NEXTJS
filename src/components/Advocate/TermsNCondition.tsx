...
export const TermsNCondition: React.FC<{
  ...
  SITEURL: string;
  title: string;
}> = ({ companyEmailAddress, lastUpdateDate, SITEURL, title }) => {
  return (
    <main>
      <article className={`${styles.terms_and_conditions}`}>
        <h1>Terms and Conditions for {title}</h1>
        ...
        <p>
          ...
          shall manage your use of our website, browser extension and desktop
          app, {title} accessible at{' '}
          <a
            href={SITEURL}
            target="_blank"
            rel="noreferrer"
        ...
        <p>
          ...
          Website, Browser Extension and Desktop App. By using this Website, you
          agreed to accept all terms and conditions written in here. You must
          not use this website, browser extension and desktop app if you
          disagree with any of these Website Standard Terms and Conditions.
        </p>
        <h2 className="pt-4 text-2xl">Interpretation and Definitions</h2>
        <h3 className="pt-2 text-xl">Interpretation</h3>
        <p>
        ...
        <h3 className="pt-2 text-xl">Definitions</h3>
        <p>For the purposes of these Terms and Conditions:</p>
        <ul className="list-outside list-disc py-2 pl-8">
          <li>
          ...
          <li>
            ...
            this Agreement) refers to Expertia, Chembur, Mumbai -400071.
          </li>
        </ul>
        <p>
        ...
        <p>
          Other than the content you own, under these Terms, {title}
        ...
        <p>
          ...
          and {title} may further restrict access by you to any areas of this
        ...
        <p>
          ...
          Content, you grant {title} a non-exclusive, worldwide irrevocable, sub
        ...
        <p>
          ...
          third-party’s rights. {title} reserves the right to remove any of Your
        ...
        <p>
          ...
          {title} express no representations or warranties, of any kind related
        ...
        <p>
          In no event shall {title}, nor any of its officers, directors and
          ...
          under contract. &nbsp;{title}, including its officers, directors and
        ...
        <p>
          You hereby indemnify to the fullest extent {title} from and against
        ...
        <p>
          {title} is permitted to revise these Terms at any time as it sees fit,
          and by using this Website you are expected to review these Terms on a
          regular basis.
        </p>
        <h2>Assignment</h2>
        <p>
          The {title} is allowed to assign, transfer, and subcontract its rights
        ...
        <p>
          These Terms constitute the entire agreement between {title} and you in
        ...
        <ul className="list-outside list-disc py-2 pl-8">
          <li>By email: {companyEmailAddress}</li>
        </ul>
      </article>
    </main>
  );
