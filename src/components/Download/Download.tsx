      ...
      <div className="mx-auto max-w-screen-xl py-8 px-4 sm:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
            {props.downloadProp.title}
          </p>
          <div className="flex justify-center text-center">
            <button
              className="mx-2 flex w-auto items-center rounded-lg border bg-gray-900 px-4 py-2"
              onClick={() => openInNewTab(AppConfig.EXE_URL)}
            >
              <svg
                viewBox="0 0 75 24"
                width="75"
              ...
              <div className="ml-3 text-left">
                <p className="text-xs text-gray-200">
                  {props.downloadProp.buttonText.textone}
                </p>
                <p className="text-sm md:text-base">
                  {props.downloadProp.buttonText.texttwo}
                </p>
              </div>
            </button>
          </div>
